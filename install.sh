...
if [ $development = true ]; then
	...
	echo "30	3	*	*	*	$scriptLocation/update.sh >> $appLocation/logs/radio-mnm-update.log 2>&1  # Radio M&M: Don't edit this line by hand – it's autogenerated by a script." >> tmp.cron
	#     -		-	-	-	-
	#     |		|	|	|	|
